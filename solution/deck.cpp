...
void Deck::Populate()
{
    ...
    for (int s = Card::CLUBS; s <= Card::SPADES; ++s)
            for (int r = Card::ACE; r <= Card::KING; ++r)
                /*
                 * Note, in C++ a static_cast is a specific type of casting of a variable.
                 * You can consider it more precise than C's cast such as:
                 * (Card::rank) r, (Card::suit) s
                 *
                 * Other casts include const_cast, dynamic_cast, reinterpret_cast.
                 * For more information view: http://www.cplusplus.com/doc/tutorial/typecasting/
                 */
